...
public struct ExpandableText: View {
    ...
    var font: Font = Font.gloryMedium(with: 16)
    var lineLimit: Int = 3
    var foregroundColor: Color = .darkGrayText2
    
    var expandButton: TextSet = TextSet(text: "See More...", font: Font.gloryBold(with: 17), color: .darkGrayText2)
